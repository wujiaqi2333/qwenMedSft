...
def main():
    ...
    FINETUNED_MODEL_PATH = "../output/Qwen3-param/checkpoint-1082"  # 全参微调模型路径
    VAL_DATA_PATH = "../dataset/val.jsonl"
    ...
    swanlab.init(
        ...
        experiment_name="Qwen3-Medical-Full-Parameter-SFT",
        config={
    ...
    # 保存详细结果到文件
    with open("../results/full_param_model_comparison_results.json", "w", encoding="utf-8") as f:
        json.dump(results, f, ensure_ascii=False, indent=2)

    print(f"\n详细结果已保存到: full_param_model_comparison_results.json")
