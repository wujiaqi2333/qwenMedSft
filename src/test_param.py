...
tokenizer = AutoTokenizer.from_pretrained("../output/Qwen3-param/checkpoint-1082", use_fast=False,
                                          trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("../output/Qwen3-param/checkpoint-1082", device_map="auto",
